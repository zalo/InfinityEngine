...
assetListLoader.load(() => {
    ...
    const sheen1 = createVisual(assets.sheen.resource, new pc.Vec3(8, -1, 0), 4);
    createText(assets.font, 'Mango Velvet', 8, 1);

    const sheen2 = createVisual(assets.sheen.resource, new pc.Vec3(4, -1, 0), 4);
    ...
    const lamp = createVisual(assets.lamp.resource, new pc.Vec3(-8, -1, 0), 5);
    createText(assets.font, 'Lamp on', -8, 1);

    const lamp2 = createVisual(assets.lamp.resource, new pc.Vec3(-11, -1, 0), 5);
